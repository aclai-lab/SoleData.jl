...
function representatives(fr::Full1DFrame, r::GlobalRel, ::Union{VariableMin, VariableMax},
...
function representatives(fr::Full1DFrame, r::GlobalRel, ::VariableSoftMax, ::typeof(maximum))
    [Interval(1, X(fr)+1)]
end
function representatives(fr::Full1DFrame, r::GlobalRel, ::VariableSoftMin, ::typeof(minimum))
    [Interval(1, X(fr)+1)]
end
