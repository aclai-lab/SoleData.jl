...
function representatives(fr::Full2DFrame, r::GlobalRel, ::Union{VariableMin, VariableMax},
...
function representatives(fr::Full2DFrame, r::GlobalRel, ::VariableSoftMax, ::typeof(maximum))
    [Interval2D(Interval(1, X(fr)+1), Interval(1, Y(fr)+1))]
end
function representatives(fr::Full2DFrame, r::GlobalRel, ::VariableSoftMin, ::typeof(minimum))
    [Interval2D(Interval(1, X(fr)+1), Interval(1, Y(fr)+1))]
end
