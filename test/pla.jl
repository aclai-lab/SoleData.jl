...
@test cleanlines(PLA._formula_to_pla(formula0)[1]) in [
    cleanlines("""
.i 5
.o 1
...
@test cleanlines(PLA._formula_to_pla(formula0;
    use_scalar_range_conditions = true,)[1]) in [cleanlines("""
.i 6
.o 1
...
@test cleanlines(PLA._formula_to_pla(formula0, true)[1]) in [
    cleanlines("""
.i 4
.o 1
...
@test syntaxstring(formula) ==
      "((V1 ≤ 10) ∧ (V3 > 10) ∧ (V4 < 10)) ∨ ((V1 ≤ 10) ∧ (V2 < 0) ∧ (V3 > 10) ∧ (V4 < 10)) ∨ ((V1 ≤ 10) ∧ (V3 > 10) ∧ (V4 ≥ 10)) ∨ ((V1 ≤ 10) ∧ (V2 < 0) ∧ (V3 > 10) ∧ (V4 ≥ 10)) ∨ ((V1 ≤ 10) ∧ (V3 > 10) ∧ (V4 < 10)) ∨ ((V1 ≤ 10) ∧ (V3 ≤ 10) ∧ (V4 < 10)) ∨ ((V1 ≤ 10) ∧ (V2 < 0) ∧ (V3 ≤ 10) ∧ (V4 < 10))"
...
@test cleanlines((PLA._formula_to_pla(@scalarformula((V1 <= 0.0) ∨
                                                     (V1 <= 0.0) ∧
                                                     (V2 <=
                                                      0.0))))[1]) in [
    cleanlines(""".i 2
...
@test syntaxstring(my_espresso_minimize(@scalarformula ((V1 <= 0)) ∨
                                                       ((V1 <= 0) ∧ (V2 <= 0)))) == "V1 ≤ 0"
