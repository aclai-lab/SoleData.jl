...
@testset "RangeScalarCondition" begin
    @test compareincludes(
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
    ) == (true, true)
    @test compareincludes(
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0, 1, true, false),
    ) == (true, false)
    @test compareincludes(
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0, 1, false, true),
    ) == (true, false)
    @test compareincludes(
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0, 1, false, false),
    ) == (true, false)
    @test compareincludes(
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0.5, 1, true, true),
    ) == (true, false)
    @test compareincludes(
        RangeScalarCondition(VariableValue(:a), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0, 0.5, true, true),
    ) == (true, false)

    @test compareincludes(
        RangeScalarCondition(VariableValue(:b), 0, 1, true, true),
        RangeScalarCondition(VariableValue(:a), 0, 0.5, true, true),
    ) == (false, false)
