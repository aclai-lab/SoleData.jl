...
multilogiset = scalarlogiset(multidataset;
    ...
    conditions = vcat([[SoleData.ScalarMetaCondition(VariableMin(i), >),
...
check((DiamondRelationalConnective(IA_L)(Atom(ScalarCondition(VariableMin(2), >, 0)))),
    mod2_part, 1, SoleData.Interval(1, 2),)
